<template>
  <view v-if="visible">
    <view class="tn-toast-class tn-toast" :class="[toastClass]" :style="[toastStyle]">
      ...
      <view v-if="title" class="tn-toast__text" :class="[haveIcon || haveContent ? '' : 'tn-toast--unicon']">{{ title }}
      </view>
      <view v-if="haveContent" class="tn-toast__text tn-toast__content">{{ content }}</view>
    </view>
